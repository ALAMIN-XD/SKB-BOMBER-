...
def update():
    ...
    if (toolVersion != mainVersion):
        ...
        os.system("cd .. && rm -rf SKB-BOMBER && git clone https://github.com/atalamin/SKB-BOMBER > /dev/null 2>&1")
        
        print("\033[37mDone")
        psb("    \033[92m[\033[37m*\033[92m] \033[37mStarting Tool...")
        time.sleep(0.8)
        
        os.system("cd .. && cd SKB-BOMBER && python Skbomb.py")
...
def logo():
    ...
    print("│ \033[95mGitHub : SKB-XD80  \033[94m│".center(columns+9))
